...
{
    public partial class BackendRecipePage : Form
    {
        DeliciousEntities dbc = new DeliciousEntities();
        public int RecipeId { get; set; }
        public BackendRecipePage(int RecipeId)
        {
            InitializeComponent();
            ...
            textBox3.Text = q.RecipeDescription.ToString();
            textBox4.Text = q.RecipeCategory.ToString();
            ...
            //textBox5.Text = steps;
            //dataGridView1.DataSource = q.RecipeStep[0].Steps.ToString();
        }
